...
//		UserSignUp--class
//		getSignUpObject --will give you UserSignUp class  object
//		getUserMap --will return map dataStructure <String email,UserAccount>
//		get(email) --is a map method which will fetch data according to user email
//		getAccountStatus()--is a getter method in UserAccount Class returns string 
//		equals() - is a string method checks weather it is equal to "locked"
